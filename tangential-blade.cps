...
properties = {
  ...
  liftAtCorner: 40, // if the angle between two move is larger than 15° the blade is lift up, rotate
...
propertyDefinitions = {
  ...
  liftAtCorner:{title:"Lift at corner", description:"Minumum angle at which the blade is turned in the material, if the angle is smaller the blade is lifted and rotated", type:"integer"},
